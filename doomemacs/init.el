...
(doom! :input
       ...
       (treemacs +lsp +(treemacs-git-mode 'deferred)) ; a project drawer, like neotree but cooler
       ...
       ;; collab            ; buffers with friends. CHOSE ONLY ONE (This or below)
       ;; (collab +tunnel)  ; buffers with friends. CHOSE ONLY ONE (This or above)
       ...
       (csharp +lsp +tree-sitter +dotnet +unity) ; unity, .NET, and mono shenanigans
       ...
       (org +brain +dragndrop +gnuplot +noter +pandoc +pomodoro +pretty +roam2 +lsp +tree-sitter +pretty) ; organize your plain life in plain text
       ...
       (sh +lsp +tree-sitter +fish +powershell) ; she sells {ba,z,fi}sh shells on the C xor
       ;;sml
